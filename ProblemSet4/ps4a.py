...
def updateHand(hand, word):
    ...
    for letter in word:
        handupdated[letter] = handupdated.get(letter,0) - 1
    return handupdated
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for letter in word:
            if hand.get(letter, 0) == 0 or localhand[letter] <= 0:
                return False
            else:
                localhand[letter] = localhand.get(letter) - 1
        return True
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"',userInput,'"','earned', roundScore, 'points. Total:', totalScore, 'pints')
                # Update the hand 
    ...
    if endMessage == "Run out of letters":
